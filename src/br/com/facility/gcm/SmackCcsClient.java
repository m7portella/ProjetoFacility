...
public class SmackCcsClient {
	...
	class GcmPacketExtension extends DefaultPacketExtension {
		...
		public GcmPacketExtension(String json) {
			...
			this.json = json;
			nBO = new NegociacaoBO(EntityManagerFactorySingleton.getInstance().createEntityManager());
		}
...
//		String category = jsonObject.get("category").toString();
		...
		if ("ECHO".equals(action)) {
			...
			try {
				...
				RegIdManager.writeToFile(userName, from);
			} catch (IOException e) {
				e.printStackTrace();
			}
...
//	}
	...
	public static void main(String[] args) {
		final String userName = "213825734251" + "@gcm.googleapis.com";
		final String password = "AIzaSyAJ901Zyc1in9y89LeifYu5kA_6HWvioVU";
